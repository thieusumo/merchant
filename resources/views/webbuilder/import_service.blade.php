...
@endif
 <div class="x_panel">
    ...
    <div class="x_content">
        <form action="{{route('post-import-services')}}" method="post" id="service-import-form" enctype="multipart/form-data" name="service-import-form">
            {{ csrf_field() }}
            <div class="col-md-6">
                    <div class="row col-md-12">
                    <a href="{{route('export-service-mana')}}" class="blue">Download an import template spreadsheet</a>
                </div>
