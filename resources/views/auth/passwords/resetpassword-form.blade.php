    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card center">
                ...
                <div class="card-header"><h5>{{ __('Reset New Password') }}</h5></div>
                ...
                <div class="card-body">
                    ...
                    @endif
                    <form method="POST" action="{{ route('change-newpass') }}">
                        @csrf
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="email" type="email" class="form-control{{ $errors->has('email') ? ' is-invalid' : '' }}" name="email" value="{{$passwordReset->email}}" >
                            </div>
                        </div>
